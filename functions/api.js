...
app.post("/api/email", handleRequestData, function (req, res, next) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="text-align: center;">
                                                            ...
                                                            <h1 style="font-family: Georgia, Times, 'Times New Roman', serif; font-size: 61px; color: #0a0a0a;">${
                                                              requestData.name
                                                            } has sent you a message!</h1>
                                                            <p>${`${
                                                              requestData.name
  ...
  try {
    sgMail
      ...
      .catch((error) => {
        res
          .json({ error: error, errorMsg: "Sorry something went wrong!" })
          .sendStatus(400);
      });
  } catch (error) {
    res
